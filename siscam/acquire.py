...
class AcquireThreadSony(AcquireThread): # when acquisition is started: self.imgproducer_sony = AcquireThreadSony(self, cam=VCam.VCam(), queue=self.imagequeue_sony, configfile = self.configfile_sony,nimg=nimg)

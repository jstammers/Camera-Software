...
# TO DO: Double check PNG-stuff: Size, brightness, Cam.py error messages	
...
class ConsumerThreadAVTTripleImage(ConsumerThread):
    ...
    def run(self):
        ...
        while self.running:
            try:
                nr1, img1 = self.queue.get(timeout=5)
				
                nr2, img2 = self.queue.get(timeout=5)
				
                nr3, img3 = self.queue.get(timeout=5)
